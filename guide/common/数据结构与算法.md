...
如果 a<sup>x</sup> =N（a>0，且a≠1），那么数x叫做以a为底N的对数，记作x=log<sub>a</sub>N，读作以a为底N的对数，其中a叫做对数的底数，N叫做真数。
...
参考
[不搞清这8大算法思想，刷再多题效果也不好的](https://mp.weixin.qq.com/s/vGjcX4nHv6QT2-qKHZM8Dw)